...
function Posticks() {
  ...
  const searchingArr = posts.filter((item) =>
    item.text.toLowerCase().includes(searchPost)
  );
      ...
      <div className='container' id='container'>
        ...
        <div className='choose-color-div'>
          ...
          <div
            className='small-box'
            id='choose-blue-box'
            onClick={() => manageColorPost('lightblue')}
          ></div>
          <div
            className='small-box'
            id='choose-pink-box'
            onClick={() => manageColorPost('lightpink')}
          ></div>
          <div
            className='small-box'
            id='choose-coral-box'
            onClick={() => manageColorPost('lightcoral')}
          ></div>
          <div
            className='small-box'
            id='choose-yellow-box'
            onClick={() => manageColorPost('lightyellow')}
          ></div>
        </div>
        <div>
